...
const Navbar = () => {
    ...
    const StyleActive = {
        paddingLeft: '2rem', paddingRight: '2rem', marginBottom: '0', color: '#2b86f0', fontWeight: 600, fontSize: 16, cursor: 'pointer',
    }
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                <svg width="76" height="20" viewBox="0 0 76 20" fill="none">
                                    ...
                                    <path d="M42.2419 17.6623H51.5146V10.9091H43.0147V8.57143H51.5146V2.33766H42.2419V0H54.3479V20H42.2419V17.6623Z"
                                        fill="black"></path>
                                    <path d="M72.6355 2.33766H64.9084V7.27273H62.5902V0H75.2113V20H72.6355V2.33766Z" fill="black"></path>
                                </svg>
                            </div>
                        </a>
                    </Link>
                    ...
                    <div>
                        <ul style={{ margin: 0, display: 'flex', justifyContent: 'space-evenly', alignContent: 'center', alignItems: 'center' }}>
                            ...
                            <li style={{ marginBottom: 0 }}><Link href="/users" style={{ textDecoration: 'none', color: 'inherit' }} passHref>
                                <Button light css={isActiveRoute('/users')} color="stuff" auto>
                                    Locataires
                                </Button></Link>
                            </li>
