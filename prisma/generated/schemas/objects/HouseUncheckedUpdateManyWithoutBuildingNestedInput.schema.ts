...
const Schema: z.ZodType<Prisma.HouseUncheckedUpdateManyWithoutBuildingNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => HouseUpdateManyWithWhereWithoutBuildingInputObjectSchema,
          ),
          z
            .lazy(
              () => HouseUpdateManyWithWhereWithoutBuildingInputObjectSchema,
...
export const HouseUncheckedUpdateManyWithoutBuildingNestedInputObjectSchema =
  Schema;
