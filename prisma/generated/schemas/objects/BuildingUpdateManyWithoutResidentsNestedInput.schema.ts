...
const Schema: z.ZodType<Prisma.BuildingUpdateManyWithoutResidentsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BuildingUpdateManyWithoutResidentsNestedInputObjectSchema = Schema;
