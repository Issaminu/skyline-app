...
const Schema: z.ZodType<Prisma.HouseUncheckedCreateNestedManyWithoutBuildingInput> =
  z
    .object({
      create: z
        .union([
...
export const HouseUncheckedCreateNestedManyWithoutBuildingInputObjectSchema =
  Schema;
