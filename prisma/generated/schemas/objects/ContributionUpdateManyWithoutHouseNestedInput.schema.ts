...
const Schema: z.ZodType<Prisma.ContributionUpdateManyWithoutHouseNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ContributionUpdateManyWithoutHouseNestedInputObjectSchema = Schema;
