...
const Schema: z.ZodType<Prisma.BuildingCreateNestedManyWithoutCreatorInput> = z
  .object({
    create: z
      .union([
...
export const BuildingCreateNestedManyWithoutCreatorInputObjectSchema = Schema;
