...
const Schema: z.ZodType<Prisma.BuildingCreateNestedManyWithoutResidentsInput> =
  z
    .object({
      create: z
        .union([
...
export const BuildingCreateNestedManyWithoutResidentsInputObjectSchema = Schema;
