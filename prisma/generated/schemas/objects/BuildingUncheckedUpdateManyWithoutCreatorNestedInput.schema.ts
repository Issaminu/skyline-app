...
const Schema: z.ZodType<Prisma.BuildingUncheckedUpdateManyWithoutCreatorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BuildingUncheckedUpdateManyWithoutCreatorNestedInputObjectSchema =
  Schema;
