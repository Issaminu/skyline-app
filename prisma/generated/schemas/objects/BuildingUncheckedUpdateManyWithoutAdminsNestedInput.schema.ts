...
const Schema: z.ZodType<Prisma.BuildingUncheckedUpdateManyWithoutAdminsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => BuildingUpdateManyWithWhereWithoutAdminsInputObjectSchema,
          ),
          z
            .lazy(
              () => BuildingUpdateManyWithWhereWithoutAdminsInputObjectSchema,
...
export const BuildingUncheckedUpdateManyWithoutAdminsNestedInputObjectSchema =
  Schema;
