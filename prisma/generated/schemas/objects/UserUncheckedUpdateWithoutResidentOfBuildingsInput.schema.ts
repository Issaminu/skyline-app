...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutResidentOfBuildingsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutResidentOfBuildingsInputObjectSchema =
  Schema;
