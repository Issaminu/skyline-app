...
const Schema: z.ZodType<Prisma.ExpenseUpdateManyWithoutAdminNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ExpenseUpsertWithWhereUniqueWithoutAdminInputObjectSchema),
        z
          .lazy(() => ExpenseUpsertWithWhereUniqueWithoutAdminInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ExpenseUpdateWithWhereUniqueWithoutAdminInputObjectSchema),
        z
          .lazy(() => ExpenseUpdateWithWhereUniqueWithoutAdminInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ExpenseUpdateManyWithoutAdminNestedInputObjectSchema = Schema;
