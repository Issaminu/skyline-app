...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutInvitationsReceivedInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutInvitationsReceivedInputObjectSchema =
  Schema;
