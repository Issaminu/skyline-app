...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutContributionsInput> = z
  .object({
    id: z
      .union([
        z.number(),
    ...
    creatorOfBuildings: z
      ...
      .optional(),
    Expenses: z
      .lazy(() => ExpenseUncheckedUpdateManyWithoutAdminNestedInputObjectSchema)
      .optional(),
    InvitationsSent: z
      .lazy(
...
export const UserUncheckedUpdateWithoutContributionsInputObjectSchema = Schema;
