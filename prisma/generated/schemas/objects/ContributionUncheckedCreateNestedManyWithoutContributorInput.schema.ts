...
const Schema: z.ZodType<Prisma.ContributionUncheckedCreateNestedManyWithoutContributorInput> =
  z
    .object({
      create: z
        .union([
...
export const ContributionUncheckedCreateNestedManyWithoutContributorInputObjectSchema =
  Schema;
