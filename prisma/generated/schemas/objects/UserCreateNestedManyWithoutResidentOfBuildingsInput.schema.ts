...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutResidentOfBuildingsInput> =
  z
    .object({
      create: z
        .union([
...
export const UserCreateNestedManyWithoutResidentOfBuildingsInputObjectSchema =
  Schema;
