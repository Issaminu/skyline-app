...
import { UserUpdateManyWithoutResidentOfBuildingsNestedInputObjectSchema } from './UserUpdateManyWithoutResidentOfBuildingsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.BuildingUpdateWithoutCreatorInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    residents: z
      .lazy(
        () => UserUpdateManyWithoutResidentOfBuildingsNestedInputObjectSchema,
      )
      .optional(),
    admins: z
...
export const BuildingUpdateWithoutCreatorInputObjectSchema = Schema;
