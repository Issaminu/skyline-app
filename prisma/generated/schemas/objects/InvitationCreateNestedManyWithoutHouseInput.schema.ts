...
const Schema: z.ZodType<Prisma.InvitationCreateNestedManyWithoutHouseInput> = z
  .object({
    create: z
      .union([
...
export const InvitationCreateNestedManyWithoutHouseInputObjectSchema = Schema;
