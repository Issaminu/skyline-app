...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutAdminOfBuildingsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutAdminOfBuildingsNestedInputObjectSchema =
  Schema;
