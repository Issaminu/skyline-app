...
const Schema: z.ZodType<Prisma.InvitationUncheckedUpdateManyWithoutHouseNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InvitationUncheckedUpdateManyWithoutHouseNestedInputObjectSchema =
  Schema;
