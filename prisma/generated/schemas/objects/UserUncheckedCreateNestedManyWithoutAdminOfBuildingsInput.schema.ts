...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutAdminOfBuildingsInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutAdminOfBuildingsInputObjectSchema =
  Schema;
