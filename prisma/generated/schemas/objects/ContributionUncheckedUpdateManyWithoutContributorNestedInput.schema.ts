...
const Schema: z.ZodType<Prisma.ContributionUncheckedUpdateManyWithoutContributorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ContributionUncheckedUpdateManyWithoutContributorNestedInputObjectSchema =
  Schema;
