...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutResidentOfBuildingsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutResidentOfBuildingsInputObjectSchema =
  Schema;
