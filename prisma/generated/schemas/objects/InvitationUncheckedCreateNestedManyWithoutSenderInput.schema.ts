...
const Schema: z.ZodType<Prisma.InvitationUncheckedCreateNestedManyWithoutSenderInput> =
  z
    .object({
      create: z
        .union([
...
export const InvitationUncheckedCreateNestedManyWithoutSenderInputObjectSchema =
  Schema;
