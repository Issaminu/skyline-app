...
const Schema: z.ZodType<Prisma.InvitationUncheckedUpdateManyWithoutSenderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InvitationUncheckedUpdateManyWithoutSenderNestedInputObjectSchema =
  Schema;
