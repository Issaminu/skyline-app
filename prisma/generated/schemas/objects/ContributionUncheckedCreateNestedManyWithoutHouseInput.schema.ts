...
const Schema: z.ZodType<Prisma.ContributionUncheckedCreateNestedManyWithoutHouseInput> =
  z
    .object({
      create: z
        .union([
...
export const ContributionUncheckedCreateNestedManyWithoutHouseInputObjectSchema =
  Schema;
