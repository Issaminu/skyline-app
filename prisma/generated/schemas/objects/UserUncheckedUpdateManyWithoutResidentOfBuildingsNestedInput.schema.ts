...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutResidentOfBuildingsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutResidentOfBuildingsNestedInputObjectSchema =
  Schema;
