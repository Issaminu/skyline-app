...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutInvitationsReceivedInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutInvitationsReceivedInputObjectSchema =
  Schema;
